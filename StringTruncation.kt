...
//Begin with...
//For each...
//[hello..., yogesh , rashmi..., what is..., A ,  , LeetCode..., Given an..., compress..., Begin with..., For each..., test ]

fun main() {
val stringArray = arrayOf("hello myname is anthoni","yogesh", "rashmi chaudhary", "what is going on", "A", " ", "LeetCode https://leetcode.com › discuss › kotlin-solution",
"Given an array of characters chars" , "compress it using the following algorithm:" ,"Begin with an empty string s",
                          "For each group of consecutive repeating","test" )
