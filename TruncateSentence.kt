//Kotlin Truncate Sentence Algorithm
...
//Example 2: Input: s = "What is the solution to this problem", k = 4 Output: "What is the solution" 
...
//Example 3: Input: s = "chopper is not a tanuki", k = 5 Output: "chopper is not a tanuki"

Constraints:*1 <= s.length <= 500 k is in the range [1, the number of words in s].    *s consist of only lowercase and uppercase English letters and spaces.
            *The words in s are separated by a single space.    *There are no leading or trailing spaces.
